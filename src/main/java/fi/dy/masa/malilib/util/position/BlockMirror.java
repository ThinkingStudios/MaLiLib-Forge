...
public enum BlockMirror implements IConfigOptionListEntry, StringIdentifiable
{
    ...
    public static final EnumCodec<BlockMirror> CODEC = StringIdentifiable.createCodec(BlockMirror::values);
    public static final IntFunction<BlockMirror> INDEX_TO_VALUE = ValueLists.createIdToValueFunction(BlockMirror::getIndex, values(), ValueLists.OutOfBoundsHandling.WRAP);
