...
public enum BlockRotation implements IConfigOptionListEntry, StringIdentifiable
{
    ...
    public static final EnumCodec<BlockRotation> CODEC = StringIdentifiable.createCodec(BlockRotation::values);
    public static final IntFunction<BlockRotation> INDEX_TO_VALUE = ValueLists.createIdToValueFunction(BlockRotation::getIndex, values(), ValueLists.OutOfBoundsHandling.WRAP);
