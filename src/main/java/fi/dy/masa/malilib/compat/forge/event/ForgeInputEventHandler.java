...
public class ForgeInputEventHandler {
    ...
    @SubscribeEvent
    public void onGuiKeyboardKeyPressPre(ScreenEvent.KeyboardKeyPressedEvent.Pre event) {
    ...
    @SubscribeEvent
    public void onGuiKeyboardKeyReleasePre(ScreenEvent.KeyboardKeyReleasedEvent.Pre event) {
    ...
    @SubscribeEvent
    public void onGuiMouseClickPre(ScreenEvent.MouseClickedEvent.Pre event) {
    ...
    @SubscribeEvent
    public void onGuiMouseReleasePre(ScreenEvent.MouseReleasedEvent.Pre event) {
    ...
    @SubscribeEvent
    public void onGuiMouseScrolledPre(ScreenEvent.MouseScrollEvent.Pre event) {
    ...
    @SubscribeEvent
    public void onGuiMouseMovedPre(ScreenEvent.MouseDragEvent.Pre event) {
