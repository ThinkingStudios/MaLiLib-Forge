...
public class TestInputHandler implements IKeybindProvider
{
    ...
    public void addHotkeys(IKeybindManager manager)
    {
        ...
        manager.addHotkeysForCategory(MaLiLibReference.MOD_NAME, MaLiLibReference.ID + ".hotkeys.category.test_enum_hotkeys", ImmutableList.copyOf(TestEnumConfig.values()));
    }
}
